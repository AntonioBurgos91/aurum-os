...
fn draw_spotlight(pm: &mut Pixmap) {
    ...
    pb.line_to(
        handle_start_x + handle_len * 0.707,
        handle_start_y + handle_len * 0.707,
    );
...
fn draw_settings(pm: &mut Pixmap) {
    ...
    for i in 0..8 {
        ...
        fill_round_rect(
            pm,
            tooth_cx - tooth_w / 2.0,
            tooth_cy - tooth_h / 2.0,
            tooth_w,
            tooth_h,
            tooth_w / 3.0,
...
const ICONS: &[IconSpec] = &[
    IconSpec {
        filename: "aurum-finder",
        paint: draw_finder,
    },
    IconSpec {
        filename: "aurum-spotlight",
        paint: draw_spotlight,
    },
    IconSpec {
        filename: "aurum-settings",
        paint: draw_settings,
    },
    IconSpec {
        filename: "aurum-mission",
        paint: draw_mission,
    },
    IconSpec {
        filename: "aurum-browser",
        paint: draw_browser,
    },
    IconSpec {
        filename: "aurum-terminal",
        paint: draw_terminal,
    },
    IconSpec {
        filename: "aurum-editor",
        paint: draw_editor,
    },
    IconSpec {
        filename: "aurum-jupyterlab",
        paint: draw_jupyter,
    },
    IconSpec {
        filename: "aurum-marimo",
        paint: draw_marimo,
    },
    IconSpec {
        filename: "aurum-ollama",
        paint: draw_ollama,
    },
    IconSpec {
        filename: "aurum-mlflow",
        paint: draw_mlflow,
    },
    IconSpec {
