...
fn draw(pm: &mut Pixmap, w: u32, h: u32) {
    ...
    for _ in 0..n_stars {
        ...
        if (s >> 60) & 0xF == 0 {
            ...
            fill_round_rect(
                ...
                1.0,
                0.5,
                rgba8(bright, bright, (bright as u16 + 30).min(255) as u8, 230),
            );
        }
    }
    ...
    let draw_hill =
        |pm: &mut Pixmap, base_y: f32, amp: f32, segments: usize, color: Color, phase: f32| {
            ...
            for i in 0..segments {
                ...
                let h_offset =
                    (mid * 0.013 + phase).sin() * amp + (mid * 0.041 + phase).sin() * amp * 0.35;
